...
offline = false
targetpc = '0'
ownerNumber = ["6281220578545@s.whatsapp.net"]
fake = '𝚁𝚎𝚣𝚣𝙱𝚘𝚝𝚣'
fake1 = '_*© 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 𝚁𝙴𝚉𝚉 𝙾𝙵𝙲*_'
numbernye = '0'
waktu = '-'
alasan = '-'
	...
	try {
      ...
      xdev.sendMessage(from, commandsDB[i].balasan, text, {quoted: dev})
            ...
            /////***𝙁𝙐𝙉𝙏𝙄𝙊𝙉 𝘼𝙉𝙏𝙄𝙇𝙄𝙉𝙆 𝙂𝙍𝙐𝙋***\\\\\
				...
				reply(` *「 GROUP LINK DETECTOR 」*\nKamu mengirimkan link grup, bot punya auto kick lho hehe:(`)
				setTimeout(() => {
...
xdev.sendMessage(from, `*Stalkerin Aja Tuh*\n*https://instagram.com/nnda.krnwn_*`, text, {quoted: dev})
}
if (button == '🔍 NEKOPOI') {
console.log('YOUTUBE')
xdev.sendMessage(from, `*Subscribe Chanel Owner Ya*\n_https://youtube.com/channel/UCUD6SkJfxrZXU0NeEO06-JA_`, text, {quoted: dev})
}
if (budy.startsWith('$')){
if (!dev.key.fromMe && !isOwner) return
qur = budy.slice(2)
